		...
		if (noise.equals("g")) {
			...
			if (Sea.equals("S")) {
				...
				JOptionPane.showMessageDialog(null,
						"you happily live in the pineapple under the sea for the rest of your life (end) ");
			}
			}
			// (n1)
			if (noise.equals("n")) {
				...
				if (option.equals("s")) {
					...
					JOptionPane.showMessageDialog(null,
							"The animals start to growl.. and then pounce! You wake up again to find yourself where you first woke up (end)");
				}
				if (option.equals("r")) {
					JOptionPane.showMessageDialog(null,
							"You look the other way and start sprinting as fast as you can");
					JOptionPane.showMessageDialog(null,
							"After a couple minutes you stop running and look back, that animal was gone");
					JOptionPane.showMessageDialog(null, "Suddenly, you hear your stomach growl");
					String berries = JOptionPane
							.showInputDialog("Go look for something to eat (e) ignore it and move on (m)");
					// (e1)
					if (berries.equals("e")) {
						JOptionPane.showMessageDialog(null,
								"You decide to look for food, so you searched the area and found some berries");
						String food = JOptionPane
								.showInputDialog("eat the berries (p) look for something else to eat (i)");

						// (p)
						if (food.equals("p")) {
							JOptionPane.showMessageDialog(null, "You start picking the berries");
							JOptionPane.showMessageDialog(null,
									"After eating a couple handfulls, your stomach starts to hurt");
						...
						if (food.equals("i")) {
							JOptionPane.showMessageDialog(null,
									"You suspect that the berries may be poisonous, you look for something else to eat");
							JOptionPane.showMessageDialog(null,
									"You found a big apple tree with apples of multiple colors");
							String colorfulApples = JOptionPane
									.showInputDialog("purple apple (P) orange apple (O) pink apple (I)");
							...
							if (berries.equals("m")) {
								...
								JOptionPane.showMessageDialog(null,
										"As soon as you come in something caught your attention");
								JOptionPane.showMessageDialog(null, "A multi-colored potion");
								JOptionPane.showMessageDialog(null,
										"You walk up to it and open the bottle. You start chugging it down with no concern");
								JOptionPane.showMessageDialog(null,
										"Just a second later your stomach starts to hurt ");
								JOptionPane.showMessageDialog(null, "your vision starts to get blurry");
								JOptionPane.showMessageDialog(null, "And then...");
								JOptionPane.showMessageDialog(null, "POOF!!");
								JOptionPane.showMessageDialog(null,
										"You turned into a multi-colored giraff with a short neck (end)");
							}
						}
